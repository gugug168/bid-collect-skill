...
> 最后验证：2026-08-22（管网30→90→365天为空；无关键词30天命中）
...
管网30/90/365天为空，无关键词复扫命中G687公路施工招标公告；位置/供货期标签不再污染 scope。17字段终态为 VL=3、VD=6、ND=4、R=4，无 `FIELD_UNVERIFIED`。能力转正不冒充管网关键词命中。机器证据：`reference/evidence/b2-epoint-project18-20260822.json`。

...
> 最后验证：2026-08-22（B2 project18，管网30→90天分层验收）
...
管网30天为空、90天命中3条；另取农村污水治理EPC 1条。17字段终态为 VL=4、VD=12、R=1，无 `FIELD_UNVERIFIED`；仅保证金因验证码附件受限。机器证据：`reference/evidence/b2-epoint-project18-20260822.json`。

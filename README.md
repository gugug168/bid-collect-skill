...
project18 字段推进截至 2026-08-22：广东基线、A1/A2/A3、B1/B2/B3/B4/C1/C2 共55个 adapter 的17字段均已形成可审计终态；机器矩阵剩余 `FIELD_UNVERIFIED` 119格。终态包含已验证、失败、OCR、无样本、未披露和受限，不代表每列非空。

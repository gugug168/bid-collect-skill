...
- 截至 2026-08-22，广东基线、A1、A2、A3、B1、B2 与 B3（新疆、江西、青海、宜昌、潍坊、无锡）共40个 adapter 已无 `FIELD_UNVERIFIED`；其余批次仍有374格待验收。新疆兵团的字段能力来自无关键词官方样本，新疆本次无关键词30天为空；均不得冒充非管网命中或全国完成。

...
- 截至 2026-08-21，广东基线、A1（湖南、湖北、贵州、云南、内蒙古、天津、吉林）、A2（安徽、西藏、甘肃、辽宁、福建、重庆、河南）与 A3（青岛、武汉、济南、宁波、中山、南京、深圳）共22个 adapter 已无 `FIELD_UNVERIFIED`；其余批次仍有680格待验收，不得外推为全国完成。
